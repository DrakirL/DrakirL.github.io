...
### Shield Properties
**???** <br>
**Worn?:** Can be equipped by merely wearing it, and may be used despite not holding it in either hand. <br>
**Hefty:** Takes more than 1 Action to be used. How many must be used is defined.

## Armor
In inventory: Goes under "Worn" to be used. Needless to say, you can't wear multiple suits of armor at once. <br>
Every type of armor has a defined Defence Bonus and an Agility Limit. You add the Defence Bonus of the armor you are wearing to your Defence, but in exchange the bonus added by your Agility is reduced to match its Agility Limit. (PHRASING) <br>
