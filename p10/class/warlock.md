...
## Starting Knowledge
+ **Languages:** Any one.
+ **Training:** Either Folklore, Occultism, or Science.
+ **Spells:** Any three.
...
### Level 1: Pact Boon
You have recieved a Boon from a greater entity, in the shape of a physical object, intended to either aid you in fulfilling your end of the bargain or as a means of fulfilling its end of the bargain to you. Regardless of its nature as an object, you can use your Boon as a focus to cast any Spell you know.<br>
...
Your Familiar is a Tiny creature of the same type as the entity that gave you the Boon and its Level is the same as yours. It has a d4 assigned to each Attribute, and the same die assigned to each Skill as you do.<br>
It has 4 Walk Speed, 4 Fly Speed, and understands all languages you do, though it can't speak.<br>
It has 2 Actions: d4/d4 (PHRASING? Balancing?)<br>
Your Familiar has no MP of its own, instead sharing access to yours.
<br><br>
Your Familiar can use 1 Action on its turn to make a Ranged Magic Attack with a range of 5 paces, dealing 1* damage on a hit and ending its turn afterwards. You choose the type for this damage when you gain this feature.<br><br>

If Warlock is your main Class, you also gain the following benefits:<br>
+ You belong to the Expert Class Group.
+ Assign a d8 to two different Skills.
...
You can perform a 1 minute ritual to summon a new copy of your Boon into your hands, causing the original to disintegrate, wherever it is.<br><br>

If Warlock is your main Class, you also gain the following benefits:<br>
+ You belong to the Mage Class Group.
+ Choose a Spell List to be your Bestowed List. Whenever you pick a Talent, you may also learn 1 new spell from your Bestowed List.

### Level 1: Overwhelming Power? Consuming Potential?
...
**Prerequisite:** *Pact Boon*<br>
You gain one of the following benefits, determined by the Boon you've chosen:

#### Boon of the Bauble
Your Familiar's Actions become d6/d6?
#### Boon of the Blade
You can use your Pact Boon to make a Magic Range Attack with the same effects on a hit. Its range is 10 paces.
#### Boon of the Book
You can perform a 1 minute ritual reading your Boon to regain all your MP.
...
#### Boon of the Book
You can perform rituals reading your Boon an unlimited number of times?
